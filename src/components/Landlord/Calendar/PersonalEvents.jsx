...
class PersonalEvents extends PureComponent {
  static propTypes = {
    ...
    return (
      ...
      >
        ...
        <Typography textMediumGrey fontSizeS style={{ marginBottom: 22 }}>
          {t("personalEvents") + ` (${this.visitRequests.length})`}
        </Typography>
...
export default withRouter(
  withWidth()(withStyles(styleSheet)(withTranslation("common")(PersonalEvents)))
);
